...
class FieldModel
{
    ...
    public function validate($value)
    {
        ...
        $isAutoGenerated = in_array($apiField, $autoGeneratedFields, true) || in_array($this->getFieldName(), $autoGeneratedFields, true);

        $rules = [];
        if ($this->isMandatory() && !($isAutoGenerated && ($value === null || $value === ''))) {
            $rules[] = 'required';
        } else {
            $rules[] = 'nullable';
        }
